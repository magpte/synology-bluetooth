...
mkdir -p /toolkit/build_env/ds.rtd1296-7.2/usr/local/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/sysroot/usr/src
tar xvf linux-4.4.302.tar.gz -C /toolkit/build_env/ds.rtd1296-7.2/usr/local/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/sysroot/usr/src/

# chroot
mount --bind /dev /toolkit/build_env/ds.rtd1296-7.2/dev
chroot /toolkit/build_env/ds.rtd1296-7.2/

export PATH="${PATH}:/usr/local/aarch64-unknown-linux-gnu/bin"
export CROSS=aarch64-unknown-linux-gnu
export CC=${CROSS}-gcc
export LD=${CROSS}-ld
export AS=${CROSS}-as
export CXX=${CROSS}-g++
export CROSS_COMPILE=/usr/local/aarch64-unknown-linux-gnu/bin/aarch64-unknown-linux-gnu-
export ARCH=arm64

# we are in chroot, compile the modules
make -C /usr/local/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/sysroot/usr/lib/modules/DSM-7.2/build M=/usr/local/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/sysroot/usr/src/linux-4.4.302/net/bluetooth/ -e CONFIG_BT=m modules

make -C /usr/local/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/sysroot/usr/lib/modules/DSM-7.2/build M=/usr/local/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/sysroot/usr/src/linux-4.4.302/drivers/bluetooth/ -e CONFIG_BT_HCIBTUSB=m modules
